...
import { ChatCompleteMessageParams } from "@google/genai";
        ...
        if (userId != existingAgent.id){
            ...
            `;
               ...
               const previousMessages = channel.state.messages
                ...
                .map<ChatCompleteMessageParams>((message) => ({
                    role: message.user?.id === existingAgent.id ? "assistant" : "user",
                    content: message.text || "",
                }));

                const GEMINIResponse = await genaiClient.chats.completions.create({
                    messages: [
                ...
                const GEMINIResponseText = GEMINIResponse.choices[0].message.content;
